...
, family (o_orderstatus)
, family (o_orderpriority)
, family (o_shippriority)
, family (o_totalprice,o_orderdate)
, family (o_clerk)
)
;
...
, family (l_returnflag)
, family (l_quantity,l_extendedprice,l_discount)
) -- INTERLEAVE IN PARENT orders (l_orderkey)
;
